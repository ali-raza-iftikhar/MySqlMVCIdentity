...
namespace MVCappWithMySQL.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public UserRolesTableRepository UserRolesRepository
        {
            get
            {
                return new UserRolesTableRepository(new ApplicationDbContext("DefaultConnection"));
            }
            set
            {
        ...
        public ActionResult ValidateRole()
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // UserRolesTableRepository _userRoleManager = new UserRolesTableRepository(new ApplicationDbContext("DefaultConnection"));
                    var role = RoleManager.FindByName("Admin");
                    UserRolesRepository.Insert(user, role.Id);

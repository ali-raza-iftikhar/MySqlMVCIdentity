...
namespace AspNet.Identity.MySQL
{
    ...
    /// </summary>
    public class UserStoreRepository<TUser> : IUserLoginStore<TUser>,
    ...
    {
        private UserTableRepository<TUser> userTable;
        private RoleTableRepository roleTable;
        private UserRolesTableRepository userRolesTable;
        private UserClaimsTableRepository userClaimsTable;
        private UserLoginsTableRepository userLoginsTable;
        ...
        {
            new UserStoreRepository<TUser>(new MySQLDatabase());
        }
        ...
        public UserStoreRepository(MySQLDatabase database)
        {
            Database = database;
            userTable = new UserTableRepository<TUser>(database);
            roleTable = new RoleTableRepository(database);
            userRolesTable = new UserRolesTableRepository(database);
            userClaimsTable = new UserClaimsTableRepository(database);
            userLoginsTable = new UserLoginsTableRepository(database);
        }
